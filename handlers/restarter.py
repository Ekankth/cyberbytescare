...
async def restart_get(client: Client, message: Message):
    try:
        CyberBytesCare = await message.reply_text("**Restarting userbot...**")
        await restart(message, restart_type="restart")
    except:
        await CyberBytesCare.edit_text("**An error occured...**")
...
async def update(client: Client, message: Message):
    try:
        ...
        link = "https://github.com/cyberbytescare/cyberbytescareuserbot/archive/refs/heads/main.zip"
