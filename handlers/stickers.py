...
#         return await kang_msg.edit("`Please Reply to a Sticker!`")
    ...
    packshortname = f"CyberBytesCareUB_{message.from_user.id}_{pack}"
    emoji = "🤔"
    try:
    ...
    if exist:
        ...
        await kang_msg.edit("**Sticker Kanged!** \n\n**Emoji:** {} \n**Pack:** [Here](https://t.me/addstickers/{})".format(emoji, packshortname))
        try:
            if os.path.exists("Kanged_Sticker_CyberBytesCareUB.png"):
                os.remove("Kanged_Sticker_CyberBytesCareUB.png")
