...
import helpers.mongo.welcomedb as CyberBytesCare
...
async def welcome(client, message):
    await CyberBytesCare.clear_welcome(str(message.chat.id))
...
async def new_welcome(app: Client, message):
    msg_id = await CyberBytesCare.get_welcome(str(message.chat.id))
    caption = ""
    men = ""
...
async def setwelcome(app: Client, message):
    ...
    await CyberBytesCare.save_welcome(str(message.chat.id), msg_id)
