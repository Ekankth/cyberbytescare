class First:
    ALIVE = "`Still Working 🔥`"
    REPO = 'Click <a href="GitHub.com/CyberBytesCare/CyberBytesCareUserbot">here</a> to open Usebot\'s GitHub page.'
    CREATOR = 'I was created by my master <a href="https://github.com/CyberBytesCare">CyberBytesCare</a> on a sexy night.'
